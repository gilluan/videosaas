  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Welcome to your VideoSaaS dashboard</p>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">Pro plan - 15 minutes ago</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">$79.00 - 1 hour ago</p>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">342 GB / 500 GB</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">23,456 / 50,000</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
